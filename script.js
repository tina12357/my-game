...
function showResult() {
  ...
  if (totalScore <= 4) {
    ...
    resultHTML = `
      <h2>【韌性數位社會】🧠</h2>
      <p> <h3>你成功推動了比照歐盟標準的數位法制，確立了「數位皮夾專法」。\n\n雖然開發速度較慢，但因為落實了 FOC 原則，保障了民眾「選擇不使用」的權利，並透過法律畫清了發證單位與服務商的權限界線。數位皮夾成為安全、透明且受到公眾信任的基礎建設，台灣成為國際數位人權的標竿。<h3></p>
    `;
  }
